...
const skillsData = [
  {
    ...
    name: 'HTML',
    level: 90,
    description: 'HTML (HyperText Markup Language) is the standard language for creating web pages.',
    delay: 100,
  },
  {
    ...
    name: 'CSS',
    level: 95,
    description: 'CSS (Cascading Style Sheets) is used to style HTML elements on a webpage.',
    delay: 200,
  },
  {
    ...
    name: 'Bootstrap',
    level: 80,
    description: 'Bootstrap is a front-end framework for building responsive websites quickly.',
    delay: 300,
  },
  {
    ...
    name: 'Javascript',
    level: 70,
    description: 'avaScript is a programming language used to make web pages interactive and dynamic',
    delay: 400,
  },
  // {
  ...
  //   delay:400},
  {
    ...
    name: 'React',
    level: 90,
    description: 'React is a JavaScript library for creating dynamic and reusable user interfaces, particularly for single-page applications.',
    delay: 400,
  },

{
  icon: "fa-brands fa-angular",
  color: "rgb(221 27 35)",       // Angular red
  background: "rgb(255 235 238)", // light red background
  name: "Angular",
  level: 50,
  description: "Building dynamic single-page applications using Angular framework.",
  delay: 400,
},
  ...
  },
  {
    ...
    name: 'Github',
    level: 55,
    description: 'GitHub is a web-based platform for hosting, managing, and collaborating on Git repositories for development projects.',
    delay: 400,
  },
];
          ...
          {skillsData.map((skill, index) => (
            ...
            >
              ...
              {skill?.svg ? (
                ...
                <i style={{color:skill?.color,background:skill.background}} class={`${skill.icon}`}></i>)}
                <h3 class="text-end">{skill.name}</h3>
